# ///////////////////////////////////////////////////////////////
#
# PySide6 Dracula PaddleOCR Edition
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        description = "\u57fa\u4e8e PaddleOCR \u7684\u56fe\u5f62\u754c\u9762\u8bc6\u522b\u5de5\u5177 - PySide6 Dracula \u98ce\u683c"
        ...
        widgets.titleRightInfo.setText("\u5f00\u542f PySide6 Dracula PaddleOCR...")
    ...
    def load_image(self, file_path: str):
        ...
        widgets.ocr_image_info.setText(f"\U0001f4c4 {file_name}")
    ...
    def show_export_menu(self):
        ...
        menu.setStyleSheet("""
            ...
            QMenu::item:selected {
                background-color: rgba(189, 147, 249, 60);
            }
        """)
        txt_action = menu.addAction('\U0001f4c4 \u5bfc\u51fa\u4e3a TXT')
        json_action = menu.addAction('\U0001f4cb \u5bfc\u51fa\u4e3a JSON')
        excel_action = menu.addAction('\U0001f4ca \u5bfc\u51fa\u4e3a Excel')
    ...
    def export_results(self, format_type: str):
        ...
        img_name = os.path.splitext(os.path.basename(self.current_image_path))[0] if self.current_image_path else 'ocr_result'
        timestamp = datetime.now().strftime('%Y%m%d_%H%M%S')
        filename = f"{img_name}_{timestamp}{ext}"
        output_dir = os.path.dirname(self.current_image_path) if self.current_image_path else '.'

        try:
            from core import get_exporter
            exporter = get_exporter()
            result_for_export = {'success': True, 'texts': self.current_result.get('texts', [])}
            ...
            if entry.get('success'):
                ...
                if self.current_image_path and os.path.exists(self.current_image_path):
                    ...
                    if not pixmap.isNull():
                        ...
                        widgets.ocr_image_label.setText('')
                        widgets.ocr_image_label.setAlignment(Qt.AlignmentFlag.AlignCenter)
                        widgets.ocr_image_info.setText(f"\U0001f4c4 {entry.get('filename', '')}")
                        widgets.ocr_btn_recognize.setEnabled(True)
            else:
